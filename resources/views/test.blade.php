<!doctype html>
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}">
    <head>
        <!-- Meta Tags -->
		<meta charset="utf-8">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								...
								<li><i class="fa fa-en"></i><a href="{{ LaravelLocalization::getLocalizedURL('en') }}">en</a></li>
      							<li><i class="fa fa-ar"></i><a href="{{ LaravelLocalization::getLocalizedURL('ar') }}">ar</a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
					</div>
									...
									<nav class="navigation">
										<ul class="nav menu">
											...
											<li><a href="#">{{ __('messages.Pages') }} <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
													<li><a href="404.html">{{ __('messages.404_Error') }}</a></li>
												</ul>
											</li>
